...
Instead pin to the release tag (e.g. `?ref=tags/x.y.z`) of one of our [latest releases](https://github.com/https://github.com/humn-ai/tf-mod-aws-security-group/releases).
...
- [terraform-aws-modules/terraform-aws-security-group](https://github.com/terraform-aws-modules/terraform-aws-security-group) - forked module
...
File a Github [issue](https://github.com/humn-ai/tf-mod-aws-security-group/issues), or message us on [Slack][slack]
